/*
 * Generated by JasperReports - 07/05/26 00:19
 */
...
public class InformeAnalisisPartidos_1778123941948_692631 extends JREvaluator
{
    ...
    private JRFillField field_ENTRAPORCENTAJE = null;
    private JRFillField field_votos = null;
    ...
    private void initFields(Map fm)
    {
        ...
        field_ENTRAPORCENTAJE = (JRFillField)fm.get("ENTRAPORCENTAJE");
        field_votos = (JRFillField)fm.get("votos");
    ...
    public Object evaluate(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 8 : 
            {
                value = ((java.lang.Integer)variable_REPORT_COUNT.getValue()) % 2 == 0; //$JR_EXPR_ID=8$
                break;
            }
            case 9 : 
            {
                value = ((java.lang.Integer)field_votos.getValue()); //$JR_EXPR_ID=9$
                break;
            }
            case 10 : 
            {
                value = new java.text.DecimalFormat("#,##0.00").format(((java.lang.Double)field_PORCENTAJE.getValue())) + "%"; //$JR_EXPR_ID=10$
                break;
            }
            case 11 : 
            {
                value = (((java.lang.Boolean)field_ENTRAPORCENTAJE.getValue()) ? "\u2713" : "\u2717"); //$JR_EXPR_ID=11$
                break;
            }
            case 12 : 
            {
                value = ((java.lang.String)field_nombre.getValue()); //$JR_EXPR_ID=12$
                break;
            }
            case 13 : 
            {
                value = (((java.lang.Boolean)field_ENTRAPORCENTAJE.getValue()) ? "Entro en la reparticion de cargos" : "No entro en la reparticion de cargos"); //$JR_EXPR_ID=13$
                break;
            }
            case 14 : 
            {
    ...
    public Object evaluateOld(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 8 : 
            {
                value = ((java.lang.Integer)variable_REPORT_COUNT.getOldValue()) % 2 == 0; //$JR_EXPR_ID=8$
                break;
            }
            case 9 : 
            {
                value = ((java.lang.Integer)field_votos.getOldValue()); //$JR_EXPR_ID=9$
                break;
            }
            case 10 : 
            {
                value = new java.text.DecimalFormat("#,##0.00").format(((java.lang.Double)field_PORCENTAJE.getOldValue())) + "%"; //$JR_EXPR_ID=10$
                break;
            }
            case 11 : 
            {
                value = (((java.lang.Boolean)field_ENTRAPORCENTAJE.getOldValue()) ? "\u2713" : "\u2717"); //$JR_EXPR_ID=11$
                break;
            }
            case 12 : 
            {
                value = ((java.lang.String)field_nombre.getOldValue()); //$JR_EXPR_ID=12$
                break;
            }
            case 13 : 
            {
                value = (((java.lang.Boolean)field_ENTRAPORCENTAJE.getOldValue()) ? "Entro en la reparticion de cargos" : "No entro en la reparticion de cargos"); //$JR_EXPR_ID=13$
                break;
            }
            case 14 : 
            {
    ...
    public Object evaluateEstimated(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 8 : 
            {
                value = ((java.lang.Integer)variable_REPORT_COUNT.getEstimatedValue()) % 2 == 0; //$JR_EXPR_ID=8$
                break;
            }
            case 9 : 
            {
