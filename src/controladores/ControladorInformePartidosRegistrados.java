 ...
 */
public class ControladorInformePartidosRegistrados {

    // Referencia a la vista donde se mostrara el informe
    private final InformePartidosRegistrados vista;

    // Ruta del archivo JRXML del reporte
    private static final String RUTA_JRXML =
        "/informes/informePartidos2.jrxml";
     ...
     */
    public ControladorInformePartidosRegistrados(
        InformePartidosRegistrados vista,
        MenuPrincipal menu
    ) {
        ...
        if (menu.getBtnInfPartidosReg() != null) {

            // Evento del boton para generar el informe
            menu.getBtnInfPartidosReg().addActionListener(
