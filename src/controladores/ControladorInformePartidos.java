...
/**
 * Controlador que gestiona la visualizacion del informe de partidos politicos.
...
public class ControladorInformePartidos {
     ...
     * @param vista panel del informe de partidos politicos
     */
    public ControladorInformePartidos(InformePartidos vista) {
        this.vista = vista;
        iniciarEventos();
    }
